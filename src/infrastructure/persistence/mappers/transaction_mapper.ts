...
export class TransactionMapper {
  ...
  static toPersistente(domain: Transaction): TransactionEntity {
    ...
    entity.sending_account = AccountMapper.toPersistence(
      domain.getSendingAccount(),
    );
    entity.receiving_account = AccountMapper.toPersistence(
      domain.getReceivingAccount(),
    );
