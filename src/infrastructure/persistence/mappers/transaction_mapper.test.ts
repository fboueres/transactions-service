...
describe("TransactionMapper", () => {
  it("should map TransactionEntity to Transaction", () => {
    ...
    expect(domain.getSendingAccount().getId()).toBe(entity.sending_account.id);
    expect(domain.getReceivingAccount().getId()).toBe(
  ...
  it("should map Transaction to TransactionEntity", () => {
    const sending_account = new Account(ulid(), "Sending Account");
    const receiving_account = new Account(ulid(), "Receiving Account");
    ...
    expect(entity.sending_account.id).toBe(domain.getSendingAccount().getId());
    expect(entity.receiving_account.id).toBe(
